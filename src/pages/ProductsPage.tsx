...
export default function ProductsPage() {
  ...
  const products = [
    {
      id: 1,
      name: "Kursus Intensif CPNS 2026",
    ...
    {
      id: 2,
      name: "Buku Strategi Kuliah Luar Negeri",
      category: "Phisical Book",
      price: "Rp 185.000",
              ...
              {products.map((product) => (
                <div key={product.id} className="group bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                  ...
                  <div className="p-8 space-y-6">
                    <div>
                      <h3 className="text-xl font-black text-gray-900 leading-tight group-hover:text-primary-600 transition-colors mb-2">{product.name}</h3>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="p-4 bg-primary-50 rounded-2xl border border-primary-100">
                        ...
                        <div className="text-sm font-black text-primary-600">{product.commission}</div>
                      </div>
                    </div>

                    <Button size="lg" rounded="full" className="w-full shadow-xl shadow-primary-100 flex items-center justify-center gap-2 group">
                      Dapatkan Link
               ...
               <div className="p-10 lg:p-12 border-b border-gray-50 flex flex-wrap items-center justify-between gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      <div className="text-xs font-black text-gray-400 uppercase tracking-widest">Total Produk Aktif</div>
                      <div className="text-xl font-black text-primary-600">12 Produk</div>
                    </div>
                      ...
                      {[1, 2, 3].map((i) => (
                        <tr key={i} className="hover:bg-gray-50/50 transition-colors group">
                           <td className="px-10 py-8">
                             <div className="flex items-center gap-4">
                               <div className="w-16 h-16 rounded-2xl bg-gray-100 overflow-hidden flex-shrink-0">
                                  <img src={products[i-1].image} className="w-full h-full object-cover" />
                               </div>
                               <div>
                                 <div className="font-black text-gray-900 leading-tight mb-1">{products[i-1].name}</div>
                           ...
                           <td className="px-10 py-8 text-right">
                              <button className="p-3 bg-gray-100 text-gray-500 rounded-xl hover:bg-primary-600 hover:text-white transition-all shadow-sm">
